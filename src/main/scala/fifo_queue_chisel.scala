...
class fifo_queue_chisel(
	//AsyncFifo built-in module has been deprecated since Chisel2 and here is the design from Pobu
...
object fDriver extends App {
  chisel3.Driver.execute(args, () => new fifo_queue_chisel)
}